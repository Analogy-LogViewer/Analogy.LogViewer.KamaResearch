...
namespace Analogy.LogViewer.KamaResearch.IAnalogy
{
    ...
    {
        protected override string RepositoryURL { get; set; } = "https://api.github.com/repos/Analogy-LogViewer/Analogy.LogViewer.KamaResearch";
        ...
        public override string Name { get; set; } = "Kama Research And Development";
